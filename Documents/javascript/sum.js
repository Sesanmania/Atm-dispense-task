...
function andriodPhone(isAndriod, isSamsung){
    if(isAndriod && isSamsung){
        return 'welcome to andriod world'
    }
...
function passangerRequest(isDriverVerified, isLicensedValid, rating){
    ...
    if (isDriverVerified && isLicensedValid && rating > 4.0){
        return 'incoming ride request by Adebayo, ACCEPT OR REJECT'

    }
    return 'connecting you with a driver, please wait'
}
   console.log(passangerRequest(1,1,4.6));

// function outsideTemperature(isCold, isWarm, census){
//   if(isCold === 1 && isCold ===15 && isWarm ===16 && isWarm ===30 && census >31){
//     if(isCold >16){
//         return "outside is cold";
//     }
//     return "outside is cold";

//   }
//   return "outside is warm";
// }
// console.log(outsideTemperature(50,50,1));
